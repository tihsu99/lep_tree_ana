...
class TruthMatchProcessor(BaseProcessor):
    ...
    def run(self, dl_dict):
        ...
        # for id_algo in ["baseline"]:
        for id_algo in ["baseline", "Haid_pionRich", "Haidn_pionTag", "Haidr_pionTag", "Haide_pionTag", "Haidc_pionTag"]:
            self.output_dir = f"{base_output_dir}/{id_algo}/"
            os.makedirs(self.output_dir, exist_ok=True)
