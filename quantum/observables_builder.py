...
def build_observables(tau_a_p4, tau_b_p4, vis_a_p4, vis_b_p4):
    ...
    # Build separate helicity bases in the tau-a and tau-b rest frames.
    # The previous implementation overwrote the tau-a-rest basis with the
    # tau-b-rest basis, which can force pathological observable values.
