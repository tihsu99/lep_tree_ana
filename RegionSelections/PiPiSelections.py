...
def get_dict_of_pipi_selection_names():
    prefix = get_cut_name()
    return {
        f'{prefix}_0': 'start of pi-pi selection',
        f'{prefix}_1': 'E/p for both leading particles < 0.6',
        f'{prefix}_2': 'number of photons near leading pion == 0 in each hemisphere',
        f'{prefix}': 'end of pi-pi selection',
    }

def get_flag_passes_pipi_region(events: ak.Array):
