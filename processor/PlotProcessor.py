...
class PlotProcessor(BaseProcessor):
    ...
    def run(self, dl: DataLoader.DataLoader):
        ...
        # theta of tau1
        theta_tau1 = dl.vectored_data['pipi/TRUTH/tau1'].theta
        ax.hist(theta_tau1, bins=bins, histtype='step', label='tau1', density=True)
        # theta of tau2
        theta_tau2 = dl.vectored_data['pipi/TRUTH/tau2'].theta
        ...
        # costh of tau1
        costh_tau1 = dl.vectored_data['pipi/TRUTH/tau1'].costheta
        ax.hist(costh_tau1, bins=bins, histtype='step', label='tau1', density=True)
        # costh of tau2
        costh_tau2 = dl.vectored_data['pipi/TRUTH/tau2'].costheta
        ...
        # pT of tau1
        pt_tau1 = dl.vectored_data['pipi/TRUTH/tau1'].pt
        ax.hist(pt_tau1, bins=bins_pt, histtype='step', label='tau1', density=True)
        # pT of tau2
        pt_tau2 = dl.vectored_data['pipi/TRUTH/tau2'].pt
        ...
        angle_tau1_pi = dl.vectored_data['pipi/TRUTH/tau1'].deltaangle(dl.vectored_data['pipi/TRUTH/vischild_tau1'])
        ax.hist(angle_tau1_pi, bins=bins, histtype='step', label='tau1 vs pi1', density=True)
        # angle between tau2 and vischild_tau2_p4
        angle_tau2_pi = dl.vectored_data['pipi/TRUTH/tau2'].deltaangle(dl.vectored_data['pipi/TRUTH/vischild_tau2'])
        ...
        tau1_p4 = dl.vectored_data['pipi/TRUTH/tau1']
        tau2_p4 = dl.vectored_data['pipi/TRUTH/tau2']
        ...
        vischild_tau1_p4 = dl.vectored_data['pipi/TRUTH/vischild_tau1']
        vischild_tau2_p4 = dl.vectored_data['pipi/TRUTH/vischild_tau2']
        nu1_p4 = dl.vectored_data['pipi/TRUTH/nu_tau1']
        nu2_p4 = dl.vectored_data['pipi/TRUTH/nu_tau2']
        ...
        inv_mass_z = dl.vectored_data['pipi/TRUTH/Z'].mass
        ...
        # -----------------------------------------------
        fig, ax = plt.subplots(dpi=300)
        cos_angle_tau1 = dl.vectored_data['pipi/TRUTH/tau1'].costheta
        cos_angle_tau2 = dl.vectored_data['pipi/TRUTH/tau2'].costheta
        ...
        # cos_angle_tau1 = np.array(dl.vectored_data['pipi/TRUTH/tau1'].costheta)
        # cos_angle_tau2 = np.array(dl.vectored_data['pipi/TRUTH/tau2'].costheta)
        ...
        # fig2, ax2 = plt.subplots(dpi=300)
        # cos_pi1 = dl.vectored_data['pipi/TRUTH/vischild_tau1'].costheta
        # cos_pi2 = dl.vectored_data['pipi/TRUTH/vischild_tau2'].costheta
